function validate() {
    ...
    if(fname.length === 0 || fname.length >30){
        showError("fname","First Name must not be empty and should be less than 30 characters long"); 
        isValid = false; 
    }
    // validate lastname
    if(lname.length === 0 || lname.length >30){
        showError("lname","Last Name must not be empty and should be less than 30 characters long"); 
        isValid = false; 
    }
    ...
    if (login.length === 0 || login.length > 30) {
        showError("login", "Username must not be empty and should be less than 30 characters long.");
        isValid = false;
    }
